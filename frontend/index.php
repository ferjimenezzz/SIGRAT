...
if (isset($_SESSION['us_id'])) {
    ...
    <head>
        ...
        <style>
            ...
            body { font-family: 'Inter', sans-serif; background: #f8fafc; margin: 0; padding: 0; color: var(--primary); }
    ...
    <body>
        <nav class="top-nav">
            <div style="display: flex; align-items: center; gap: 12px;">
                <div style="background: var(--accent); color: white; padding: 8px; border-radius: 10px;"><i class="bi bi-shield-check" style="font-size: 20px;"></i></div>
        ...
        <div class="container">
            ...
            <h3 style="font-weight: 900; margin-bottom: 24px; display: flex; align-items: center; gap: 12px;">
                <i class="bi bi-calendar3"></i> Disponibilidad de Áreas (Hoy)
            </h3>
