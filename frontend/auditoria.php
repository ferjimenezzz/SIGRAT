    ...
    <div class="card" style="padding: 0;">
        <div style="padding: 20px 24px; border-bottom: 1px solid var(--border); display: flex; justify-content: space-between; align-items: center;">
            ...
            <div style="display: flex; gap: 8px;">
                ...
                <button class="btn btn-outline" onclick="window.open('../backend/reports/audit_pdf.php' + window.location.search, '_blank')" style="color: #dc2626; border-color: #dc2626;"><i data-lucide="file-text"></i> Exportar PDF</button>
            </div>
        </div>
