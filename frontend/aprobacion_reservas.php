...
const tutorialSteps = [
  {
    title: "¡Bienvenido a Aprobaciones!",
    description: "Este recorrido interactivo te guiará en el uso del módulo de aprobación de reservas. Aprenderás a filtrar, buscar y gestionar solicitudes.",
    position: "center"
  },
  {
    target: "#tutorial-search",
    title: "Buscador Inteligente",
    description: "Filtra reservas al instante buscando por el <b>ID</b>, el nombre del <b>usuario</b> o el <b>espacio</b> solicitado.",
    position: "bottom"
  },
  {
    target: "#tutorial-tabs",
    title: "Filtros de Estado",
    description: "Cambia entre solicitudes <b>Pendientes</b>, <b>Aprobadas</b> y <b>Canceladas</b> para visualizar el listado correspondiente. <b>Haz clic en estas pestañas ahora si deseas cambiar de vista y alternar la interfaz.</b>",
    position: "bottom"
  },
  {
    target: "#tutorial-table",
    title: "Listado de Reservas",
    description: "En esta tabla se consolida la información detallada de cada solicitud: usuario, espacio, fecha, horarios y estado.",
    position: "top"
  },
  {
    target: ".tutorial-row-actions",
    title: "Acciones de Aprobación",
    description: "Como administrador, puedes <b>Aprobar</b> de inmediato una reserva en su espacio asignado, o presionar <b>Rechazar</b> para cancelarla indicando un motivo. <b>Puedes pulsar estos botones para procesar una solicitud y ver el cambio reflejado al instante.</b> <i>(Este paso se omitirá automáticamente si no hay solicitudes pendientes).</i>",
    position: "left"
  }
];
...
/* @__PURE__ */ React.createElement(TutorialGuide, { steps: tutorialSteps, moduleId: "aprobaciones" })
);
}
