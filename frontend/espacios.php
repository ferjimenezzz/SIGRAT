...
<div style="display: flex; flex-direction: column; gap: 24px;">
    ...
    <!-- 1. Pestaña Espacios -->
    <div id="tab-espacios" class="card" style="display: <?php echo $tab === 'espacios' ? 'block' : 'none'; ?>; padding: 0; overflow: auto; max-height: 500px; border-radius: 16px; border: 1px solid #e2e8f0; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05); background: white;">
